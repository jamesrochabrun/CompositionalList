...
public extension UICollectionViewLayout {
    ...
    static func composed() -> UICollectionViewLayout {
        ...
        return UICollectionViewCompositionalLayout { sectionIndex, layoutEnvironment in
            ...
            switch sectionIndex {
            case 0:
                section = .horizontalTiles(scrollingBehavior: .continuousGroupLeadingBoundary, groupSize: .init(widthDimension: .fractionalWidth(0.45), heightDimension: .fractionalWidth(0.55)), header: headers)
            case 1:
                section = .groupedList(header: headers)
            case 2:
                section = .horizontalTiles(scrollingBehavior: .continuousGroupLeadingBoundary, groupSize: .init(widthDimension: .fractionalWidth(0.92), heightDimension: .fractionalWidth(0.95)), header: headers)
            case 3:
                section = .verticalGroupTiles(scrollingBehavior: .continuousGroupLeadingBoundary, groupSize: .init(widthDimension: .fractionalWidth(0.45), heightDimension: .fractionalWidth(1.1)), header: headers)
            default:
                section = .tilesSection(header: headers)
            }
